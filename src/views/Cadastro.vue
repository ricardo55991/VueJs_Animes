      ...
      <div class="row d-flex justify-content-around">
        ...
        <div class="div-form col">
          <form class="form-login mb-5">
            ...
            <div class="mb-3">
              <input type="password" class="form-control" style="border-top: none" id="exampleInputPassword2" placeholder="Confirme a senha">
            </div>
            <button type="submit" class="btn-submit btn btn-primary mb-3">Salvar</button>
